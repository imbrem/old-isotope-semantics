...
#proof[
    ...
    we have $dropctx(Γ, cnil)$ by assumption; hence, by weakening substitution, we have $dropctx(Δ, cnil)$ and therefore applying #rstyle("nil")/#rstyle("true")/#rstyle("false") gives the desired result.
