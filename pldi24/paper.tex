...
\(|\mc{C}|\) in Figure \ref{fig:ssa-type-semantics}; this allows us to give a
semantics for structural judgements in Figure
\ref{fig:ssa-structural-semantics}.
...
followed by a semantics for blocks and label-sets in Figure
\ref{fig:ssa-block-semantics}.
