...
\begin{definition}[Substructural Monoidal Category]
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item \(\mc{A} \subseteq |\mc{C}|\) is a set of objects closed under tensor products, such that
    \begin{itemize}
      \item \(\mb{1} \in \mc{A}\)
    ...
    \end{itemize}
    \item \(\mc{R} \subseteq |\mc{C}|\) is a set of objects closed under tensor products, such that
    \begin{itemize}
      \item \(\mb{1} \in \mc{R}\)
    ...
    \end{itemize}
  \end{itemize}
  We call a substructural monoidal category a \textbf{substructural Cartesian category} if \(\mc{A} = \mc{R} = |\mc{C}|\), in which case \(\mc{C}^{\{\ms{a}, \ms{r}\}}\) is Cartesian. Many of our examples will satisfy this structure.
\end{definition}
...
\begin{definition}[Susbtructural Effectful Category]
  ...
  \begin{itemize}
    \item A substructural monoidal category \(\mc{C}_1\)
