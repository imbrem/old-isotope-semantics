...
\begin{itemize}
  ...
  \item Given submonads \(\mb{S}_i\) of \(\mb{T}\), their elementwise intersections \(\bigwedge_i\mb{S}_i = \lambda A. \bigcap_i \mb{S}_i\;A\) are submonads, forming a meet-semilattice with bottom element \(\ms{pure}(\mb{T})\) and top element \(\mb{T}\)
