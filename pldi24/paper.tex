...
semantics for control-flow graphs: \todo{this}. We can now quite easily state
the semantics of \rle{where}: we simply precompose the semantics of the inner
block \(\dnt{\haslb{\Gamma}{t}{\ms{L}}}\) with the semantics of the associated
control-flow graph \(\dnt{\lhaslb{\ms{L}}{L}{\ms{K}}}\); \todo{explain}
