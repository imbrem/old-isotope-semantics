...
We will begin by giving a useful foundation for a wide class of \isotopessa models: the "trace models", which accumulate a (potentially infinite) nondeterministic trace of monoidal "events". This will later come in handy for reasoning about output behaviour and weak memory.
...
\begin{enumerate}
  ...
  \item \todo{product, giving monoidal structure?}
...
\begin{definition}[Trace Monad]
  ...
  \(f^\dagger(a) = \bigcup_{n \in \nats \cup \{\infty\}}f_n(a)\), where
  \TODO{this}

  \TODO{deterministic trace monad; inherited Elgot structure: use as example of "Elgot submonad"? Go cite \cite{carette-central-2022}}
\end{definition}

\TODO{text}

\TODO{merge det/nondet}
...
\TODO{relevant = deterministic + idempotent; inclusion of trace monad}
