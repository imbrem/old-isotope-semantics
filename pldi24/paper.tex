...
\ref{fig:ssa-term-semantics}. Our treatment of \rle{var} is quite standard: the
expression \(x\) types in \(\Gamma\) if all other variables in \(\Gamma\) and
can be discarded, in which case the semantics is simply doing so, i.e.
