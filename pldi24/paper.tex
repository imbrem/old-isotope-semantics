...
We can then interpret a weakening \(\csplits{\Gamma}{\Delta}{\Xi}\) as a pure
...
There is a vast literature on SSA and related compiler IRs, but for space
reasons, we are forced to restrict our discussion to the most closely related
work.
