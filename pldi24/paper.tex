...
\TODO{can swap be derived from the previous two? Does this imply some of the other equations from \cite{laplaza-distributivity}? Alas for modularity!}

\TODO{results on distributivity of monads}

\TODO{results on distributivity of effectful things}
...
\TODO{coherent syntax for affine/relevant morphisms... see below...}
