...
Now that we've given a semantics to \isotopessa programs, we can begin to use it
to develop an equational theory for performing optimizations. Since we're
